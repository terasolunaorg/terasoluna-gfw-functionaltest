...
<html class="no-js">
    ...
    <head>
        ...
        <c:set var="titleKey" value="title.codelist.08_05_form" />
        ...
        <div class="wrapper">
            ...
            <form:form action="${pageContext.request.contextPath}/codelist/next" method="get" modelAttribute="existInCheckWrongCodeListForm">
                <table>
                    <tr>
                        <td>
                            <span id="errors"><form:errors path="item5" style="color: red" /></span>
                        </td>
                    </tr>
                </table>
                <table>
                    ...
                    <tr>
                        <td><input id="btn1" class="mainbtn" style="width: 200px" type="submit" value="Confirm" name="existInCheckWrongCodeList" /></td>
                        <td></td>
                    </tr>
                </table>
            </form:form>
