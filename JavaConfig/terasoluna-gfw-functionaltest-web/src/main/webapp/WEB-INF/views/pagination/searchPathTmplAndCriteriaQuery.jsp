...
<html class="no-js">
    ...
    <head>
        ...
        <c:set var="titleKey" value="title.pagination.searchPathTmplAndCriteriaQuery" />
        ...
        <div class="wrapper">
            ...
            <c:if test="${not empty page and page.totalElements != 0}">
                ...
                <div id="paginationCombinationOfPathTmplAndCriteriaQueryAndFQuery" class="pagination">
                    <t:pagination page="${page}" pathTmpl="${pageContext.request.contextPath}/pagination/21_1/{page}/{size}" criteriaQuery="${f:query(personSearchForm)}" />
                </div>
                ...
                <div id="paginationCombinationOfPathTmplAndCriteriaQueryAndFU" class="pagination">
                    <t:pagination page="${page}" pathTmpl="${pageContext.request.contextPath}/pagination/21_1/{page}/{size}" criteriaQuery="name=${f:u(personSearchForm.name)}" />
                </div>
