...
<html class="no-js">
    ...
    <head>
        ...
        <c:set var="titleKey" value="title.pagination.disabledPageLinkWithJavaScript" />
    ...
    <body>
        <div class="wrapper">
            ...
            <script type="text/javascript" src="${pageContext.request.contextPath}/resources/vendor/js/jquery.js"></script>
