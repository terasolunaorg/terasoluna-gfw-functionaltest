...
<html class="no-js">
    ...
    <head>
        ...
        <c:set var="titleKey" value="title.codepoints.containsAll_form3" />
    ...
    <body>
        <div class="wrapper">
            ...
            <form:form action="${pageContext.request.contextPath}/codepoints/containsAll" modelAttribute="containsAllForm3" method="post">
                <table>
                    <tr>
