...
<html class="no-js">
    ...
    <head>
        ...
        <c:set var="titleKey" value="title.codepoints.result_instanceCheckAndcontainsAll" />
    ...
    <body>
        <div class="wrapper">
            ...
            <p>Result (instanceCheck): <span id="instanceCheck">${f:h(instanceCheck)}</span><br /></p>
            <p>Result (containsAll): <span id="containsAll">${f:h(containsAll)}</span><br /></p>
