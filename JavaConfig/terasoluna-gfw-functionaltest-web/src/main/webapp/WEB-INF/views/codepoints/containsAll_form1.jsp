                    ...
                    <tr>
                        <td>
                            <form:select path="useInstanceKind">
                                <form:option value="codePointsOf" label="created by \"method of CodePoints\"" /> <form:option value="newJIS_X_0208_Katakana" label="created by \"new instance of
                                existing code point set(JIS_X_0208_Katakana)\"" /> <form:option value="newCodePonitsWithString" label="created by \"new instance of CodePoints with String\"" />
                                <form:option value="codePointsOfWithJIS_X_0208_Katakana" label="created by \"method of CodePoints with existing code point set(JIS_X_0208_Katakana)\"" />
                            </form:select>
                        </td>
                    </tr>
                </table>
