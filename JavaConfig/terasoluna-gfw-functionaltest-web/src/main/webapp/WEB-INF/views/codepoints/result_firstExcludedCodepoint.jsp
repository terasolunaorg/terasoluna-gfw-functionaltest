...
<html class="no-js">
    ...
    <head>
        ...
        <c:set var="titleKey" value="title.codepoints.result_firstExcludedCodepoint" />
    ...
    <body>
        <div class="wrapper">
            ...
            <p>Result (firstExcludedCodepoint): <span id="firstExcludedCodepoint">${f:h(firstExcludedCodepoint)}</span><br /></p>
