...
public class DateAndTimeController {
    ...
    public String serverTimeReturn_01_01(Model model) throws Exception {
        ...
        setAttribute(model, fixedDefaultZoneClock, tickDefaultZoneClock, fixedChangeZoneClock,
                tickChangeZoneClock);
    ...
    private void setAttribute(Model model, Clock fixedDefaultZoneClock, Clock tickDefaultZoneClock,
            Clock fixedChangeZoneClock, Clock tickChangeZoneClock) throws InterruptedException {
        ...
        // fixedDefaultZone
        model.addAttribute("fixedDefaultZoneInstant", Instant.now(fixedDefaultZoneClock));
        model.addAttribute("fixedDefaultZoneLocalDateTime",
                LocalDateTime.now(fixedDefaultZoneClock));
        model.addAttribute("fixedDefaultZoneLocalDate", LocalDate.now(fixedDefaultZoneClock));
        model.addAttribute("fixedDefaultZoneLocalTime", LocalTime.now(fixedDefaultZoneClock));
        model.addAttribute("fixedDefaultZoneOffsetDateTime",
                OffsetDateTime.now(fixedDefaultZoneClock));
        model.addAttribute("fixedDefaultZoneOffsetTime", OffsetTime.now(fixedDefaultZoneClock));
        model.addAttribute("fixedDefaultZonedDateTime", ZonedDateTime.now(fixedDefaultZoneClock));
        model.addAttribute("fixedDefaultZoneJapaneseDate", JapaneseDate.now(fixedDefaultZoneClock));

        // fixedChangeZone
        model.addAttribute("fixedChangeZoneInstant", Instant.now(fixedChangeZoneClock));
        model.addAttribute("fixedChangeZoneLocalDateTime", LocalDateTime.now(fixedChangeZoneClock));
        model.addAttribute("fixedChangeZoneLocalDate", LocalDate.now(fixedChangeZoneClock));
        model.addAttribute("fixedChangeZoneLocalTime", LocalTime.now(fixedChangeZoneClock));
        model.addAttribute("fixedChangeZoneOffsetDateTime",
                OffsetDateTime.now(fixedChangeZoneClock));
        model.addAttribute("fixedChangeZoneOffsetTime", OffsetTime.now(fixedChangeZoneClock));
        model.addAttribute("fixedChangeZoneZonedDateTime", ZonedDateTime.now(fixedChangeZoneClock));
        model.addAttribute("fixedChangeZoneJapaneseDate", JapaneseDate.now(fixedChangeZoneClock));

        // To make the difference between ticks easier to see, wait 1 second
        ThreadUtils.sleep(Duration.ofSeconds(1L));

        // tickDefaultZone
        model.addAttribute("tickDefaultZoneInstant", Instant.now(tickDefaultZoneClock));
        model.addAttribute("tickDefaultZoneLocalDateTime", LocalDateTime.now(tickDefaultZoneClock));
        model.addAttribute("tickDefaultZoneLocalDate", LocalDate.now(tickDefaultZoneClock));
        model.addAttribute("tickDefaultZoneLocalTime", LocalTime.now(tickDefaultZoneClock));
        model.addAttribute("tickDefaultZoneOffsetDateTime",
                OffsetDateTime.now(tickDefaultZoneClock));
        model.addAttribute("tickDefaultZoneOffsetTime", OffsetTime.now(tickDefaultZoneClock));
        model.addAttribute("tickDefaultZonedDateTime", ZonedDateTime.now(tickDefaultZoneClock));
        model.addAttribute("tickDefaultZoneJapaneseDate", JapaneseDate.now(tickDefaultZoneClock));

        // ftickChangeZone
        model.addAttribute("tickChangeZoneInstant", Instant.now(tickChangeZoneClock));
        model.addAttribute("tickChangeZoneLocalDateTime", LocalDateTime.now(tickChangeZoneClock));
        model.addAttribute("tickChangeZoneLocalDate", LocalDate.now(tickChangeZoneClock));
        model.addAttribute("tickChangeZoneLocalTime", LocalTime.now(tickChangeZoneClock));
        model.addAttribute("tickChangeZoneOffsetDateTime", OffsetDateTime.now(tickChangeZoneClock));
        model.addAttribute("tickChangeZoneOffsetTime", OffsetTime.now(tickChangeZoneClock));
        model.addAttribute("tickChangeZoneZonedDateTime", ZonedDateTime.now(tickChangeZoneClock));
        model.addAttribute("tickChangeZoneJapaneseDate", JapaneseDate.now(tickChangeZoneClock));
    }
}
