...
<html class="no-js">
    ...
    <head>
        ...
        <c:set var="titleKey" value="title.codepoints.firstExcludedCodePoint_form" />
    ...
    <body>
        <div class="wrapper">
            ...
            <form:form action="${pageContext.request.contextPath}/codepoints/firstExcludedCodePoint" modelAttribute="firstExcludedCodePointForm" method="post">
                <table>
                    <tr>
