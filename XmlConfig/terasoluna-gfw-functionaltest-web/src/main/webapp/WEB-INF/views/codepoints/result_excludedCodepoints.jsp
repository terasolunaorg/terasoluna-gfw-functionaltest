...
<html class="no-js">
    ...
    <head>
        ...
        <c:set var="titleKey" value="title.codepoints.result_excludedCodepoints" />
    ...
    <body>
        <div class="wrapper">
            ...
            <p>ExcludedCodepointsSize: <span id="excludedCodepointsSize">${excludedCodePoints.size()}</span><br /></p>
