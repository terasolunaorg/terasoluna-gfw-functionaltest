...
<html class="no-js">
    ...
    <head>
        ...
        <c:set var="titleKey" value="title.queryescape.todoListWithFullWidth" />
    ...
    <body>
        <div class="wrapper">
            ...
            <h2>Query Escape Function Test Using&nbsp;${f:h(targetORMapper)}&nbsp;with Full-Width escape</h2>

            input todoTitle search word and push button. choose search pattern.

            <form:form action="${pageContext.request.contextPath}/queryescape/${f:h(targetORMapper)}/search" method="get" modelAttribute="todoForm" enctype="UTF-8">
