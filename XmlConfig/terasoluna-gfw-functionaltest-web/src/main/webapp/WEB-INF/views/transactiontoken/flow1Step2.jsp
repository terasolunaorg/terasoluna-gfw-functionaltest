    ...
    <body>
        <div class="wrapper">
            ...
            <form:form action="${pageContext.request.contextPath}/transactiontoken/flow1" method="post">
                ...
                <br />
                <input id="btn-in-finish-error" name="intermediateWithFinishError" class="mainbtn" style="width: 200px" type="submit" value="Next and Finish with Error" />
                <br />
                <input id="btn-end-error" name="finalizeError" class="mainbtn" style="width: 200px" type="submit" value="Finish with Error" />
                <br />
                <input id="btn-download01" name="download01" class="mainbtn" style="width: 200px" type="button" value="File download (CHECK)" />
                <br />
            ...
            <script type="text/javascript">
                function dummyDownload(buttonId) {
                    ...
                    $.get($("#command").attr("action"), param);
                    return false;
                }

                $(document).ready(function () {
                    $("#btn-download01").on("click", function () {
                        dummyDownload("#btn-download01");
                    });
                });
            </script>
