...
<html class="no-js">
    ...
    <head>
        ...
        <c:set var="titleKey" value="title.pagination.pathQueryTmpl" />
    ...
    <body>
        <div class="wrapper">
            ...
            <div class="pagination">
                <t:pagination page="${page}" pathTmpl="${pageContext.request.contextPath}/pagination/14_1/{page}/{size}" queryTmpl="" />
            </div>
