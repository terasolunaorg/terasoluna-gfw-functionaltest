        ...
        <div class="wrapper">
            ...
            <c:if test="${not empty page and page.totalElements != 0}">
                ...
                <div id="paginationCombinationOfQueryTmplAndCriteriaQueryAndFQuery" class="pagination">
                    <t:pagination page="${page}" queryTmpl="page={page}&size={size}&sort={sortOrderProperty},{sortOrderDirection}" criteriaQuery="${f:query(personSearchForm)}" />
                </div>
                ...
                <div id="paginationCombinationOfQueryTmplAndCriteriaQueryAndFU" class="pagination">
                    <t:pagination page="${page}" queryTmpl="page={page}&size={size}&sort={sortOrderProperty},{sortOrderDirection}" criteriaQuery="name=${f:u(personSearchForm.name)}" />
                </div>
