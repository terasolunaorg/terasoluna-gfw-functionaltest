...
<html class="no-js">
    ...
    <head>
        ...
        <c:set var="titleKey" value="title.codelist.07_01_form" />
    ...
    <body>
        <div class="wrapper">
            ...
            <form:form action="${pageContext.request.contextPath}/codelist" method="get" modelAttribute="codeListForm">
                <table>
                    <tr>
                        <td><form:select path="item1" items="${CL_CODELIST01_01}" id="list1" /></td>
                    </tr>
                    <tr>
                        <td><form:select path="item1" items="${SAMPLE_CODELIST}" id="list2" /></td>
                    </tr>
                    <tr>
