...
<html class="no-js">
    ...
    <head>
        ...
        <c:set var="titleKey" value="title.codelist.08_10_form" />
        ...
        <div class="wrapper">
            ...
            <form:form action="${pageContext.request.contextPath}/codelist/next" method="get" modelAttribute="codeListForm">
                <table>
                    <tr>
                        <td>
                            <span id="errors"><span id="item1Error" style="color: red">${f:h(item1Error)}</span></span>
                        </td>
                    </tr>
                </table>
                <table>
                    ...
                    <tr>
                        <td><input id="btn1" class="mainbtn" style="width: 200px" type="submit" value="Confirm" name="existInCheckParamAnnotation" /></td>
                        <td></td>
                    </tr>
                </table>
            </form:form>
