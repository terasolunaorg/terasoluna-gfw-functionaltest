...
<html class="no-js">
    ...
    <head>
        ...
        <c:set var="titleKey" value="title.codelist.08_08_form" />
        ...
        <div class="wrapper">
            ...
            <form:form action="${pageContext.request.contextPath}/codelist/next" method="get" modelAttribute="existInCheckForm">
                <table>
                    <tr>
                        <td>
                            <span id="errors"><form:errors path="item8" style="color: red" /></span>
                        </td>
                    </tr>
                </table>
                <table>
                    ...
                    <tr>
                        <td><input id="btn1" class="mainbtn" style="width: 200px" type="submit" value="Confirm" name="existInCheckExtendedCodeList" /></td>
                        <td></td>
                    </tr>
                </table>
            </form:form>
