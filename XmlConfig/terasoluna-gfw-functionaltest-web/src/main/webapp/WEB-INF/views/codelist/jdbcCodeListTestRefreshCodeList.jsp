...
<html class="no-js">
    ...
    <head>
        ...
        <c:set var="titleKey" value="title.codelist.jdbcCodeListTestRefreshCodeList" />
        ...
        <div class="wrapper">
            ...
            <form:form action="${pageContext.request.contextPath}/codelist/next" method="get" modelAttribute="codeListForm">
                <table>
                    ...
                    <tr>
                        <td><input id="btn1" class="mainbtn" style="width: 200px" type="submit" value="Update Table" name="jdbcCodeListTestRefreshCodeList" /></td>
                    </tr>
                </table>
            </form:form>
