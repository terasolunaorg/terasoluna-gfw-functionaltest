...
public class CodePointsController {
    ...
    @RequestMapping(value = "containsAll", method = RequestMethod.POST,
            params = {"useInstanceKind=codePointsOf"})
    ...
    @RequestMapping(value = "containsAll", method = RequestMethod.POST,
            params = {"useInstanceKind=newJIS_X_0208_Katakana"})
    ...
    @RequestMapping(value = "containsAll", method = RequestMethod.POST,
            params = {"useInstanceKind=newCodePointsWithIntegerArray"})
    ...
    @RequestMapping(value = "containsAll", method = RequestMethod.POST,
            params = {"useInstanceKind=newCodePointsWithIntegerSet"})
    ...
    @RequestMapping(value = "containsAll", method = RequestMethod.POST,
            params = {"useInstanceKind=newCodePonitsWithString"})
    ...
    @RequestMapping(value = "containsAll", method = RequestMethod.POST,
            params = {"newCodePointsWithStringArray"})
