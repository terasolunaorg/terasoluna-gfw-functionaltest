...
public class ExceptionHandlingController {
    ...
    public String requestControllerHandling_01_01(Model model) {
        ...
        try {
            exceptionHandlingService
                    .throwException(new BusinessException("Error"));
    ...
    public String requestControllerHandling_01_02(Model model) {
        ...
        try {
            infoLoggingExceptionHandlingService
                    .throwException(new BusinessException(ResultMessages.info()
                            .add("i.gt.me.0004")));
        } catch (BusinessException be) {
            model.addAttribute(be.getResultMessages());
            return "exceptionhandling/errorOutput";
    ...
    public String useCaseControllerHandling_02_01() {
        ...
        exceptionHandlingService
                .throwException(new ContinueException("2_1 Continue"));
    ...
    public String servletFrameworkHandling_03_04() {
        ...
        exceptionHandlingService
                .throwException(new SystemException("e.xx.xxx", "3_4 SystemException", new Throwable("create throwable")));
    ...
    public String servletFrameworkHandling_03_05() {
        ...
        exceptionHandlingService
                .throwException(new BusinessTestException("w.yy.yyy"));
    ...
    public String servletFrameworkHandling_03_07() {
        ...
        exceptionHandlingService
                .throwException(new ResourceNotFoundException("i.xx.xxx"));
    ...
    public String servletFrameworkHandling_03_08() {
        ...
        exceptionHandlingService
                .throwException(new QueryTimeoutException("e.cc.ccc"));
    ...
    public String servletFrameworkHandling_03_09() {
        ...
        exceptionHandlingService
                .throwException(new SystemException("e.xx.xxx", "3_8 Error"));
    ...
    public String exceptionLoggerVariation_05_04() {
        ...
        exceptionHandlingService
                .throwException(new ExceptionLoggerDefaultException());
    ...
    public String exceptionLoggerVariation_05_05() {
        ...
        exceptionHandlingService
                .throwException(new MultipleChoicesException("5_5 Error "));
    ...
    public String exceptionLoggerVariation_05_06() {
        ...
        exceptionHandlingService
                .throwException(new BusinessMessageException("5_6 Error"));
