...
<table>
    ...
    <tr>
        <td><a id="codelist_11_03" href="${pageContext.request.contextPath}/codelist/11_01_form">SimpleI18nCodeList Test (specified nation locale and returned in fallback language locale)</a></td>
    </tr>
    <tr>
        <td><a id="codelist_11_04" href="${pageContext.request.contextPath}/codelist/11_01_form">SimpleI18nCodeList Test (specified language locale and returned in fallbackTo locale)</a></td>
    </tr>
    <tr>
