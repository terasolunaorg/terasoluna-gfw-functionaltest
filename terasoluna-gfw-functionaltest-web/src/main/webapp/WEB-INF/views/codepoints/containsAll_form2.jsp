        ...
        <tr>
            <td>
                <form:select path="useInstanceKind">
                    <form:option value="newCodePointsWithIntegerArray" label="created by \"new instance of CodePoints with Integer array\"" /> <form:option value="newCodePointsWithIntegerSet"
