    ...
    <form:form action="${pageContext.request.contextPath}/el/output_05_04" method="post">
        <span>URLPath</span><br/>
        <c:set var="URLPath" value=" http://localhost:8080${pageContext.request.contextPath}/el/output_05_04" />
        http://localhost:8080${pageContext.request.contextPath}/el/output_05_04<br/>
        <span>Input QueryParam</span><br/>
        <input id="text-outputQueryParam" type="text" class="text" name="outputQueryParam"/><br/><br/>
