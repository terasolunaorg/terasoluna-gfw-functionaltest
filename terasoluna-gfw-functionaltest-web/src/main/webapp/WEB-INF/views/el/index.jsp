...
<table>
  ...
  <tr>
    <td><a id="05_04"
      href="${pageContext.request.contextPath}/el/5_4">URL_Link(f:link()
        and f:u())</a></td>
  </tr>
  <tr>
    <td><a id="06_01-02"
  ...
  <tr>
    <td><a id="06_15"
      href="${pageContext.request.contextPath}/el/6_15">Query_Display(f:query(SimpleJavaBean))
        with StringTrimmerEditor</a></td>
  </tr>
  <tr>
    <td><a id="06_16"
      href="${pageContext.request.contextPath}/el/6_16">Query_Display(f:query(ListOfSimpleValue))
        with StringTrimmerEditor</a></td>
  </tr>
  <tr>
    <td><a id="06_17"
      href="${pageContext.request.contextPath}/el/6_17">Query_Display(f:query(MapOfSimpleValue))
        with StringTrimmerEditor</a></td>
  </tr>
  <tr>
    <td><a id="07_01"
