...
<form:form action="${pageContext.request.contextPath}/el/6_16/search" method="GET" modelAttribute="listForm">
    <fieldset>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <form:checkbox path="listB" value="b0" label="b0" /><br /> <form:checkbox path="listB" value="b1" label="b1" /><br /> <form:checkbox path="listB" value="b2" label="b2" /><br />
                </td>
                <td>
                    <form:select path="listC">
        ...
        <fieldset>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <form:checkbox path="item.listB" value="bb0" label="bb0" /><br /> <form:checkbox path="item.listB" value="bb1" label="bb1" /><br />
                        <form:checkbox path="item.listB" value="bb2" label="bb2" /><br />
                    </td>
                    <td>
                        <form:select path="item.listC">
                            <form:option value="" label="--Please Select(Multiple)" />
