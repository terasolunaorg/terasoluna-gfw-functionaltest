...
<form:form
	...
	method="post">
	<input id="btn-begin1" name="confirm" class="mainbtn"
		style="width: 400px;" type="submit"
		value="Size = 2, Namespace Setting = Class and Method" />
	<br>
	<br>
	<input id="btn-begin1-other" name="confirmOther" class="mainbtn"
		style="width: 400px;" type="submit"
		value="Other non conflicting operation" />
</form:form>
<br>
<form:form
	action="${pageContext.request.contextPath}/transactiontoken/customTransactionStoreSize2/createFlow_2/"
	method="post">
	<input id="btn-begin2" name="confirm" class="mainbtn"
		style="width: 400px;" type="submit"
...
<form:form
	...
	method="post">
	<input id="btn-begin3" name="confirm" class="mainbtn"
		style="width: 400px;" type="submit"
