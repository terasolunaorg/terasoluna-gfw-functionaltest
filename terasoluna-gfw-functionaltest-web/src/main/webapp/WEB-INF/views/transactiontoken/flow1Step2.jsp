...
<form:form
  ...
  <br>
  <input id="btn-in-finish" name="intermediateWithFinish"
    class="mainbtn" style="width: 200px;" type="submit"
    value="Next and Finish" />
  <br>
  <input id="btn-in-finish-error" name="intermediateWithFinishError"
    class="mainbtn" style="width: 200px;" type="submit"
    value="Next and Finish with Error" />
  <br>
  ...
  <br>
  <input name="redo1" class="mainbtn" style="width: 200px;"
    type="submit" value="Back" />
</form:form>
<br>
<form action="${pageContext.request.contextPath}/transactiontoken"
  method="get" target="_blank">
  <input id="open-new-window" class="mainbtn" style="width: 200px;"
    type="submit" value="Open New Window">
</form>
