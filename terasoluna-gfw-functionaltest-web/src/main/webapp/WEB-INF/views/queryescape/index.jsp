	...
	<table>
        <tr>
            <td>
                ...
                <a id="databaseId" class="form-label">${f:h(databaseId)}</a>
            </td>
            <td>
                <label class="form-label">Database Version :</label>
                <a id="databaseVersion" class="form-label">${f:h(databaseVersion)}</a>
            </td>
        </tr>
		<tr>
			<td><a id="link1"
		...
		<tr>
			<td><a id="link2"
					href="${pageContext.request.contextPath}/queryescape/JPA/">QueryEscapeUtil Function Test Using JPA</a>
			</td>
		</tr>
        <tr>
            <td><a id="link3"
