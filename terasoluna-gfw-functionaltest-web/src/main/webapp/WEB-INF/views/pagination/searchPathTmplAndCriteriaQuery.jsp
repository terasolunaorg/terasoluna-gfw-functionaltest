...
<c:if test="${not empty page and page.totalElements != 0}">
	...
	<h3 class="center-content">Combination of pathTmpl And
		criteriaQuery (f:query)</h3>
	<div id="paginationCombinationOfPathTmplAndCriteriaQueryAndFQuery"
		class="pagination">
	...
	<div id="paginationCombinationOfPathTmplAndCriteriaQueryAndFU"
		class="pagination">
		<t:pagination page="${page}"
			pathTmpl="${pageContext.request.contextPath}/pagination/21_1/{page}/{size}"
