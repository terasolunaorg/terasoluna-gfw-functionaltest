<h2>logging Function Test UserIdMDCPutFilter</h2>
	...
	<form:form action="${pageContext.request.contextPath}/logging/j_spring_security_check" method="post">
    	userId:<input type="text" id="username" name="j_username">
    	...
    	<input type="hidden" name="redirectTo" value="${pageContext.request.contextPath}/logging/userIdMDCPutFilter/login" />
	</form:form>
	...
	<table>
		<tr>
			<td><a id="userIdMDCPutFilterDefault"
					href="${pageContext.request.contextPath}/logging/userIdMDCPutFilter/2_1">default attribute name</a>
			</td>
		</tr>
		<tr>
			<td><a id="userIdMDCPutFilterCustom"
					href="${pageContext.request.contextPath}/logging/userIdMDCPutFilter/2_2">custom attribute name</a>
			</td>
		</tr>
	</table>
