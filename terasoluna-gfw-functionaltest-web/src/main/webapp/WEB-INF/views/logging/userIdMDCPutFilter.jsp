...
<form:form action="${pageContext.request.contextPath}/logging/login"
  method="post">
    	userId:<input type="text" id="username" name="username">
    	password:<input type="password" id="password" name="password">
  <input type="submit" id="btn1" class="mainbtn" style="width: 100px;"
    value="Login" />
...
<table>
  <tr>
    <td><a id="userIdMDCPutFilterDefault"
      href="${pageContext.request.contextPath}/logging/userIdMDCPutFilter/2_1">default
        attribute name</a></td>
  </tr>
  <tr>
    <td><a id="userIdMDCPutFilterCustom"
      href="${pageContext.request.contextPath}/logging/userIdMDCPutFilter/2_2">custom
        attribute name</a></td>
  </tr>
</table>
