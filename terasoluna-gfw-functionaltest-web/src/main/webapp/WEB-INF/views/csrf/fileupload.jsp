...
<form:form action="${pageContext.request.contextPath}/csrf/fileUpload" method="post"
...
<form action="${pageContext.request.contextPath}/csrf/fileUpload" method="post"
...
<form:form id="queryFileForm"
  action="${pageContext.request.contextPath}/csrf/fileUpload?${f:h(_csrf.parameterName)}=${f:h(_csrf.token)}"
