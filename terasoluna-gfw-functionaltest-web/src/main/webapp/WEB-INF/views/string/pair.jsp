...
<form:form action="${pageContext.request.contextPath}/string/${f:h(targetPath)}" modelAttribute="fullHalfPairForm" method="post">
    <table>
        <tr>
...
<c:if test="${not empty resultMessage}">
    <p><span id="resultMessage">"${f:h(resultMessage)}"</span><br /></p>
</c:if>
