...
<table>
    ...
    <tr>
        <td>
            <a id="fullHalfPairsBuilderWithStringTrimmer03" href="${pageContext.request.contextPath}/string/fullHalfPairsBuilderWithStringTrimmer?form">FullHalfPairsBuilderWithStringTrimmer_03</a>
        </td>
    </tr>
</table>
