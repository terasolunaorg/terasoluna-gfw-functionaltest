...
expect \"otxadmin\>\"
send \"create-jdbc-datasource --useJTA=true --dataSourceType=JDBC --jdbcUserName=gfw --jdbcPassword=gfw --dataSourceName=jdbc:oracle:thin:@localhost:1521/teradb  jdbc/gfwFunctionaltestDataSource\n\"
expect \"otxadmin\>\"
send \"exit\n\"
"    
#### END OF FILE ####