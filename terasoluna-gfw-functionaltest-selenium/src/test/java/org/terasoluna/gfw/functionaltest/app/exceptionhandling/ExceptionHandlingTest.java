...
public class ExceptionHandlingTest extends FunctionTestSupport {
    ...
    public void test04_03_webApplicationHandling() {
        ...
        webDriverWait.until(titleIs("Servlet Error"));
        assertThat(dbLogProvider.countContainsMessageAndLevelsAndLogger(
                "\\[e.xx.9999\\] Request processing failed; nested exception is org.terasoluna.gfw.functionaltest.domain.exception.SubClassException",
                "ERROR", "org.terasoluna.gfw.common.exception.ExceptionLogger"), is(1L));
        assertThat(dbLogProvider.countContainsMessageAndLevelsAndLogger(
                "\\[e.xx.9999\\] Request processing failed; nested exception is org.terasoluna.gfw.functionaltest.domain.exception.SubClassException",
                "ERROR", "org.terasoluna.gfw.common.exception.ExceptionLogger.Monitoring"), is(1L));
    ...
    public void test04_04_webApplicationHandling() {
        ...
        webDriverWait.until(titleIs("Servlet Error"));
        assertThat(dbLogProvider.countContainsMessageAndLevelsAndLogger(
                "\\[e.xx.9999\\] Request processing failed; nested exception is org.terasoluna.gfw.functionaltest.domain.exception.WrappingException: org.terasoluna.gfw.functionaltest.domain.exception.CauseException",
                "ERROR", "org.terasoluna.gfw.common.exception.ExceptionLogger"), is(1L));
        assertThat(dbLogProvider.countContainsMessageAndLevelsAndLogger(
                "\\[e.xx.9999\\] Request processing failed; nested exception is org.terasoluna.gfw.functionaltest.domain.exception.WrappingException: org.terasoluna.gfw.functionaltest.domain.exception.CauseException",
                "ERROR", "org.terasoluna.gfw.common.exception.ExceptionLogger.Monitoring"), is(1L));
    ...
    public void test04_05_webApplicationHandling() {
        ...
        assertThat(dbLogProvider.countContainsMessageAndLevelsAndLogger("\\[w.xx.0011\\] 4_5 Error",
                "ERROR", "org.terasoluna.gfw.common.exception.ExceptionLogger"), is(1L));
        assertThat(
                dbLogProvider.countContainsMessageAndLevelsAndLogger("\\[w.xx.0011\\] 4_5 Error",
                        "ERROR", "org.terasoluna.gfw.common.exception.ExceptionLogger.Monitoring"),
                is(1L));
    ...
    @Test
    public void test04_06_webApplicationHandling() {

        driver.findElement(By.id("webApplicationHandling_04_06")).click();

        webDriverWait.until(titleIs(""));
        assertThat(dbLogProvider.countContainsMessageAndLevelsAndLogger("\\[e.xx.9999\\] 4_6 Error",
                "ERROR", "org.terasoluna.gfw.common.exception.ExceptionLogger"), is(1L));
        assertThat(
                dbLogProvider.countContainsMessageAndLevelsAndLogger("\\[e.xx.9999\\] 4_6 Error",
                        "ERROR", "org.terasoluna.gfw.common.exception.ExceptionLogger.Monitoring"),
                is(1L));
    ...
    public void test06_01_exceptionOccuresInSharedService() {
        driver.findElement(By.id("exceptionOccuresInSharedService_06_01")).click();
    ...
    public void test06_02_exceptionOccuresInSharedService() {
        driver.findElement(By.id("exceptionOccuresInSharedService_06_02")).click();
